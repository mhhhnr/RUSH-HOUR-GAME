...
### **●Board Items:**<br>
		...
		&nbsp4. Tree —---> ‘^|’<br>
		&nbsp5. Bonus —--> ‘$’<br>
		&nbsp6. Passenger —--> ‘P’<br>
		&nbsp7. Destination —--> ‘D’<br>
### **●Taxi Movement:** <br>
		&nbsp1. Up —--> decrease in Y<br>
		&nbsp2. Down —-> increase in y<br>
		&nbsp3. Right —---> increase in x<br>
		&nbsp4. Left—---> Decrease in x<br>
## **User Manual:**<br>
...
### **●Objectives:**<br>
	&nbsp 1. Pick up Passenger<br>
	&nbsp 2. Drop off the Passenger<br>
	&nbsp 3. Do not collide with trees or NPC cars<br>
	&nbsp 4. Collect bonuses<br>
### **●Game over Conditions:**<br>
	&nbsp 1. All Passengers dropped off in career mode<br>
	&nbsp 2.Time over in time mode<br>
	&nbsp 3. Pressed esc<br>
## **UI Screenshots:**
